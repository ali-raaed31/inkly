...
<template>
  <header
    ref="header"
    class="px-4 py-3 flex items-center justify-between border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900"
  >
    <NuxtLink :to="COMPANY_URL" target="_blank" class="flex items-center gap-3">
      <img
